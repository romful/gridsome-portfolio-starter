<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="relative flex justify-around items-center py-4 h-40 sm:h-auto flex-col sm:flex-row">
      <g-link class="relative sm:w-1/2" to="/"><img src="/logo.png" /></g-link>
