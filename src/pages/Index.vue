...
<div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
  ...
  <div class="px-6 py-4">
    ...
    <p class="text-gray-700 text-base">
      Lorem ipsum dolor sit amet, consectetur aje tje testesdrrrdsqdsqdqsdqsdqsdqsdestetdipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
    </p>
  </div>
  <div class="px-6 py-4">
...
<div class="grid grid-cols-3 gap-4">
  <div class="text-center"> <g-image src="../../static/mind_map.svg" alt="browser" /></div>
  <div class="text-center"> <g-image src="../../static/mind_map.svg" alt="browser" /></div>
  <div class="text-center"> <g-image src="../../static/mind_map.svg" alt="browser" /></div>
</div>
</div>
