					...
					<div class="mx-auto max-w-sm overflow-hiddenmx-auto">
						...
						<div class="px-6 pb-4 pt-8 mx-6 -mt-4 mb-4 relative rounded-xl bg-white-700">
							...
							<p class="text-gray-700 text-base">
								<span v-if="edge.node.Booking_Up_to_X_hours != ''">Book up to : {{ edge.node.Booking_Up_to_X_hours }} <span v-if="edge.node.Up_to_X_pax > 1">hours</span><span v-else>hour</span> before<br /></span>
